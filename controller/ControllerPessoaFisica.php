...
class ControllerPessoaFisica
{
    ...
    public function cadastrar()
    {
        ...
        $pf->__set('telefoneF2', $_POST['telefoneF2']);
        $pf->__set('telefoneF3', $_POST['telefoneF3']);
        ...
        $pf->__set('arquivo', $_POST['caminhoDaFotoTirada']);
    ...
    function atualizarUsuario()
    {
        ...
        $pf->__set('telefoneF2', $_POST['n_telefone_editado2']);
        $pf->__set('telefoneF3', $_POST['n_telefone_editado3']);
