            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">                    
                    ...
                    <div class="col-xs-12 ol-sm-12 col-md-12 col-lg-12">
                                    <form action="mvc/control/ControllerPessoaFisica.php?acao=cadastrar" method="post">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="panel-body">
                                                            ...
                                                            <div class="form-group">
                                                                <input type="radio" name="sexo" id="male" class="with-gap">
                                                                <label for="male">Masculino</label>
                                                                <input type="radio" name="sexo" id="female" class="with-gap">
                                                            ...
                                                            <div class="form-group">
                                                                <div class="form-group">
                                                                    <div class="form-line">
                                                                        <input type="tel" id="cepF" class="form-control" placeholder="Cep">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row clearfix">
                                                                <div class="col-sm-8">
                                                                    <div class="form-group">
                                                                        <div class="form-line">
                                                                            <input type="text" class="form-control" id="logradouroF" placeholder="Logradouro">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-4">
                                                                    <div class="form-group">
                                                                        <div class="form-line">
                                                                            <input type="tel" id="numeroF" class="form-control" placeholder="N°">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row clearfix">
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        <div class="form-line">
                                                                            <input type="text" id="bairroF" class="form-control" placeholder="Bairro">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        <div class="form-line">
                                                                            <input type="text" id="cidadeF" class="form-control" placeholder="Cidade">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        <div class="form-line">
                                                                            <input type="text" id="ufF" class="form-control" placeholder="Estado">
                                                                        </div>
                                                                    </div>
                                                                </div>
