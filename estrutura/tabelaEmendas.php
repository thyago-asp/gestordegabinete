    ...
    <tr>
        ...
        <td class="text-center">
            <div class="btn-group text-center" role="group" aria-label="Button group">
                ...
                <button class="btn btn-primary" type="button" data-toggle="modal" data-target="#modalEdicao" data-idteme="<?php echo $emenda['idt_emendas'] ?>" data-tipo_emenda="<?php echo $emenda['tipo_emenda'] ?>" data-numDoc="<?php echo $emenda['numDoc'] ?>" data-solicitante="<?php echo $emenda['solicitante'] ?>" data-beneficiario="<?php echo $emenda['beneficiario'] ?>" data-cidade="<?php echo $emenda['t_emendas_orcamentarias_idt_emendas_orcamentarias'] ?>" data-nomeContato="<?php echo $emenda['nome_de_contato'] ?>" data-dataDoc="<?php echo $emenda['data_cad_doc'] ?>" data-tipo="<?php echo $emenda['tipo'] ?>" data-titulo="<?php echo $emenda['titulo'] ?>" data-descricao="<?php echo $emenda['descricao'] ?>" data-status="<?php echo $emenda['status'] ?>"> <i class="fa fa-pencil-alt" aria-hidden="true"></i></button>
                <!-- Botão excluir -->
